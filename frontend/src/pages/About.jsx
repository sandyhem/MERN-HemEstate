...
export default function About() {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 text-slate-800">About Hem Estate</h1>
      <p  className="mb-4 text-slate-700">
        Hem Estate is a leading real estate agency that specializes in helping
      ...
      <p className="mb-4 text-slate-700">
        ...
        providingexpert advice, personalized service,and a deep understanding of
        the local market. Whether you are looking to buy,sell or rent a
      ...
      <p className="mb-4 text-slate-700">
        ...
        servie to our clients.We believe that buying or selling a property
        should be an exciting and rewarding experience,and we are dedicatec to
